<?php
/**
 * description: 省份城市数据配置
 * author: lilong3@staff.sina.com.cn
 * createTime: 2016/5/11 14:18
 */
...
return array(
    ...
    45 => array(
        'code' => 45,
        'name' => "广西",
        'city' => array(1 => "南宁", 2 => "柳州", 3 => "桂林", 4 => "梧州", 5 => "北海", 6 => "防城港", 7 => "钦州", 8 => "贵港", 9 => "玉林", 10 => "百色", 11 => "贺州", 12 => "河池", 13 => "来宾", 14 => '崇左'),
        'fw'   => 'G'
    ),
    52 => array(
        'code' => 52,
    ...
    41 => array(
        'code' => 41,
        'name' => "河南",
        'city' => array(1 => "郑州", 2 => "开封", 3 => "洛阳", 4 => "平顶山", 5 => "安阳", 6 => "鹤壁", 7 => "新乡", 8 => "焦作", 9 => "濮阳", 10 => "许昌", 11 => "漯河", 12 => "三门峡", 13 => "南阳", 14 => "商丘", 15 => "信阳", 16 => "周口", 17 => "驻马店" ,41 => '济源'),
        'fw'   => 'H'
    ),
    42 => array(
        'code' => 42,
        'name' => "湖北",
        'city' => array(1 => "武汉", 2 => "黄石", 3 => "十堰", 5 => "宜昌", 6 => "襄阳", 7 => "鄂州", 8 => "荆门", 9 => "孝感", 10 => "荆州", 11 => "黄冈", 12 => "咸宁", 13 => "随州", 28 => "恩施土家族苗族自治州"),
        'fw'   => 'H'
    ),
    43 => array(
        'code' => 43,
        'name' => "湖南",
        'city' => array(1 => "长沙", 2 => "株洲", 3 => "湘潭", 4 => "衡阳", 5 => "邵阳", 6 => "岳阳", 7 => "常德", 8 => "张家界", 9 => "益阳", 10 => "郴州", 11 => "永州", 12 => "怀化", 13 => "娄底", 31 => "湘西"),
        'fw'   => 'H'
    ),
    15 => array(
        'code' => 15,
        'name' => "内蒙古",
        'city' => array(1 => "呼和浩特", 2 => "包头", 3 => "乌海", 4 => "赤峰", 5 => "通辽", 6 => "鄂尔多斯", 7 => "呼伦贝尔", 8 => "巴彦淖尔", 9 =>"乌兰察布" , 22 => "兴安盟", 25 => "锡林郭勒盟", 26 => "乌兰察布盟", 28 => "巴彦淖尔盟", 29 => "阿拉善盟"),
        'fw'   => 'N'
    ),
    32 => array(
        'code' => 32,
    ...
    64 => array(
        'code' => 64,
        'name' => "宁夏",
        'city' => array(1 => "银川", 2 => "石嘴山", 3 => "吴忠", 4 => "固原", 5 => "中卫"),
        'fw'   => 'N'
    ),
    63 => array(
        'code' => 63,
    ...
    65 => array(
        'code' => 65,
        'name' => "新疆",
        'city' => array(1 => "乌鲁木齐", 2 => "克拉玛依", 21 => "吐鲁番", 22 => "哈密", 23 => "昌吉", 27 => "博尔塔拉", 28 => "巴音郭楞", 29 => "阿克苏", 30 => "克孜勒苏", 31 => "喀什", 32 => "和田", 40 => "伊犁", 42 => "塔城", 43 => "阿勒泰", 90 => "石河子"),
        'fw'   => 'X'
    ),
    53 => array(
        'code' => 53,
        'name' => "云南",
        'city' => array(1 => "昆明", 3 => "曲靖", 4 => "玉溪", 5 => "保山", 6 => "昭通", 8=>"普洱", 23 => "楚雄", 25 => "红河", 26 => "文山", 27 => "思茅", 28 => "西双版纳", 29 => "大理", 31 => "德宏", 32 => "丽江", 33 => "怒江", 34 => "迪庆", 35 => "临沧"),
        'fw'   => 'Y'
    ),
    33 => array(
        'code' => 33,
